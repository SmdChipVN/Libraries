...
typedef struct
{
  BUNION(SR, unsigned int,                      //              0x0000'0000     ADC status register
    ...
    _reserved                           , 27);
  BUNION(CR1, unsigned int,                     //              0x0000'0000     ADC control register 1
    ...
    _reserved1                          , 8);
  BUNION(CR2, unsigned int,                     //              0x0000'0000     ADC control register 2
    ...
    _reserved3                          , 8);
  BUNION(SMPR1, unsigned int,                   //              0x0000'0000     ADC sample time register 1
    ...
    CN17                                , 3,    //21:23         0
    _reserved                           , 8);
  BUNION(SMPR2, unsigned int,                   //              0x0000'0000     ADC sample time register 2
    CN0                                 , 3,    //0:2           0
    CN1                                 , 3,    //3:5           0
    CN2                                 , 3,    //6:8           0
    CN3                                 , 3,    //9:11          0
    ...
    CN9                                 , 3,    //27:29         0
    _reserved                           , 2);  
  unsigned int JOFFSET[4];                      //              0x0000'0000     ADC injected channel data offset register
  RSTRUCT(THRESH_HOLD, unsigned int, 
    HIGH,                                       //              0x0000'0FFF 
    LOW);                                       //              0x0000'0000
  UNION(SQR,                                    //              0x0000'0000-3   ADC regular sequence register
    ...
    BSTRUCT(BITS, unsigned int,
      ...
      CN6                               , 5,    //25:29
      _reserved2                        , 2));
  BUNION(JSQR, unsigned int,                    //              0x0000'0000     ADC injected sequence register
    ...
    _reserved                           , 10);
  unsigned int JDATA[4];                        //              0x0000'0000     ADC injected data register
  BUNION(DR, unsigned int,                      //              0x0000'0000     ADC regular data register
    DATA                                , 16,   //0:15          0               Regular data
    ADC2DATA                            , 16);  //16:31         0               ADC2 data
} ADC_TypeDef;
typedef struct
{
  RSTRUCT(SR, unsigned int,                     //              0x0000'0000     ADC status register
    ...
    _reserved                           [27]);
  RSTRUCT(CR1, unsigned int,                    //              0x0000'0000     ADC control register 1
    AWDCH                               [5],    //0:4           0               Analog watchdog channel select bits
    ...
    _reserved1                          [8]);
  RSTRUCT(CR2, unsigned int,                    //              0x0000'0000     ADC control register 2
    ...
    _reserved3                          [8]);
  RSTRUCT(SMPR1, unsigned int,                  //              0x0000'0000     ADC sample time register 1
    CN10                                [3],    //0:2           0               Channel x Sample time selection
    CN11                                [3],    //3:5           0
    CN12                                [3],    //6:8           0
    CN13                                [3],    //9:11          0
    ...
    CN17                                [3],    //21:23         0
    _reserved                           [8]);
  RSTRUCT(SMPR2, unsigned int,                  //              0x0000'0000     ADC sample time register 2
    CN0                                 [3],    //0:2           0
    CN1                                 [3],    //3:5           0
    CN2                                 [3],    //6:8           0
    CN3                                 [3],    //9:11          0
    ...
    CN9                                 [3],    //27:29         0
    _reserved                           [2]);  
  unsigned int JOFFSET[4][32];                  //              0x0000'0000     ADC injected channel data offset register
  RSTRUCT(THRESH_HOLD, unsigned int, 
    HIGH[32],                                   //              0x0000'0FFF 
    LOW[32]);                                   //              0x0000'0000
  UNION(SQR,                                    //              0x0000'0000-3   ADC regular sequence register
    RSTRUCT(REGS, unsigned int, r1[32], r2[32], r3[32]);
    RSTRUCT(BITS, unsigned int,
      CN13                              [5],    //0:4           0               16th conversion in regular sequence
      CN14                              [5],    //5:9
      CN15                              [5],    //10:14
      CN16                              [5],    //15:19
      ...
      CN6                               [5],    //25:29
      _reserved2                        [2]));
  RSTRUCT(JSQR, unsigned int,                   //              0x0000'0000     ADC injected sequence register
    CN1                                 [5],    //0:4           0               first conversion in injected sequence
    CN2                                 [5],    //5:9
    CN3                                 [5],    //10:14
    CN4                                 [5],    //15:19
    ...
    _reserved                           [10]);
  unsigned int JDATA[4];                        //              0x0000'0000     ADC injected data register
  RSTRUCT(DR, unsigned int,                     //              0x0000'0000     ADC regular data register
    DATA                                [16],   //0:15          0               Regular data
    ADC2DATA                            [16]);  //16:31         0               ADC2 data
} ADC_BITBAND_TypeDef;
//==============================================================================================================================================================
//===========================================================       LEVEL 1      ===============================================================================
//==============================================================================================================================================================
void ADC_Start(volatile ADC_TypeDef* ADC, unsigned int Channel);
