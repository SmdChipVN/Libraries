...
typedef struct
{
  BUNION(SR, unsigned int,                      //              0x0000'00C0     Status register
    ...
    CTS                                 , 1,    //9             0               CTS flag
    _Reserved                           , 22);
  unsigned int DR;                              //              0x----'----     Data register (9 bits low is used)
  BUNION(BRR, unsigned int,                     //              0x0000'0000     Baud rate register
    FRACTION                            , 4,    //0:3           0
    MANTISSA                            , 12,   //4:15          0               Baudrate = F/(MANTISSA + FRACTION / 16)
    _Reserved                           , 16);
  BUNION(CR1, unsigned int,                     //              0x0000'0000     Control register 1
    SBK                                 , 1,    //0             0               Send break
    RWU                                 , 1,    //1             0               Receiver wakeup
    RE                                  , 1,    //2             0               Receiver enable
    TE                                  , 1,    //3             0               Transmitter enable
    IDLEIE                              , 1,    //4             0               IDLE interrupt enable
    RXNEIE                              , 1,    //5             0               RXNE interrupt enable
    TCIE                                , 1,    //6             0               Transmission complete interrupt enable
    TXEIE                               , 1,    //7             0               TXE interrupt enable
    PEIE                                , 1,    //8             0               PE interrupt enable
    ...
    _Reserved                           , 18);
  BUNION(CR2, unsigned int,                     //              0x0000'0000     Control register 2
    ADD                                 , 4,    //0:3          	0               Address of the USART node
    _Reserved                           , 1,
    LBDL                                , 1,    //5           	0               lin break detection length
    LBDIE                               , 1,    //6           	0               LIN break detection interrupt enable
    _Reserved1                          , 1,     
    ...
    _Reserved2                          , 17);
  BUNION(CR3, unsigned int,                     //              0x0000'0000     Control register 3
    ...
    CTSIE                               , 1,    //10            0               CTS interrupt enable
    _reserved, 21);
  BUNION(GTPR, unsigned int,                    //              0x0000'0000     Guard time and prescaler register
...
typedef struct
{
  RSTRUCT(SR, unsigned int,                     //              0x0000'00C0     Status register
    ...
    _Reserved                           [22]);
  unsigned int DR;                              //              0x----'----     Data register (9 bits low is used)
  RSTRUCT(BRR, unsigned int,                    //              0x0000'0000     Baud rate register
    FRACTION                            [4],    //0:3           0
    MANTISSA                            [12],   //4:15          0               Baudrate = F/(MANTISSA + FRACTION / 16)
    _Reserved                           [16]);
  RSTRUCT(CR1, unsigned int,                    //              0x0000'0000     Control register 1
    SBK                                    ,    //0             0               Send break
    RWU                                    ,    //1             0               Receiver wakeup
    RE                                     ,    //2             0               Receiver enable
    TE                                     ,    //3             0               Transmitter enable
    IDLEIE                                 ,    //4             0               IDLE interrupt enable
    RXNEIE                                 ,    //5             0               RXNE interrupt enable
    TCIE                                   ,    //6             0               Transmission complete interrupt enable
    TXEIE                                  ,    //7             0               TXE interrupt enable
    PEIE                                   ,    //8             0               PE interrupt enable
    ...
    _Reserved                           [18]);
  RSTRUCT(CR2, unsigned int,                    //              0x0000'0000     Control register 2
    ADD                                 [4],    //0:3          	0               Address of the USART node
    _Reserved                              ,
    LBDL                                   ,    //5           	0               lin break detection length
    LBDIE                                  ,    //6           	0               LIN break detection interrupt enable
    _Reserved1                             ,     
    ...
    _Reserved2                          [17]);
  RSTRUCT(CR3, unsigned int,                    //              0x0000'0000     Control register 3
    EIE                                    ,    //0          	0               Error interrupt enable
    ...
    RTSE                                   ,    //8          	0               RTS enable
    CTSE                                   ,    //9          	0               CTS enable
    CTSIE                                  ,    //10            0               CTS interrupt enable
    _reserved                           [21]);
  RSTRUCT(GTPR, unsigned int,                   //              0x0000'0000     Guard time and prescaler register
    PSC                                 [8],    //0:7        	0               Prescaler value
    GT                                  [8],    //8:15         	0               Guard time value
    _reserved                           [16]);
...
//===========================================================       LEVEL 1      ===============================================================================
//==============================================================================================================================================================
#define UART_EnableDMA_TX(UART)                 ((UART_TypeDef*)(UART))->CR3.REG |= BIT7
#define UART_DisableDMA_TX(UART)                ((UART_TypeDef*)(UART))->CR3.REG &= ~BIT7
#define UART_EnableDMA_RX(UART)                 ((UART_TypeDef*)(UART))->CR3.REG |= BIT6
#define UART_DisableDMA_RX(UART)                ((UART_TypeDef*)(UART))->CR3.REG &= ~BIT6
//-----------------------------------------------------------       LEVEL 1      -------------------------------------------------------------------------------
/*
+) NOTE:
  -NVIC must enable
...
//-----------------------------------------------------------       LEVEL 1      -------------------------------------------------------------------------------
void UART_Init(volatile UART_TypeDef* UART, unsigned int F_UART, unsigned int Baudrate);        //F_UART: KHz
//-----------------------------------------------------------       LEVEL 1      -------------------------------------------------------------------------------
#define UART_WriteByte(UART, Data)              (UART)->DR = Data; while (!((UART)->SR.TXE))
//-----------------------------------------------------------       LEVEL 1      -------------------------------------------------------------------------------
